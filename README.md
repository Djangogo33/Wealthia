...
- Répartition freemium suggérée à valider :
  ...
  - **Pro** : export PDF/XLSX, Open Banking, notifications push, multi-devises, widget
  - **Max** : IA patrimoniale, immobilier, emprunts, webhooks, WhatsApp, back-office admin
...
*(post-lancement, fidélisation et montée en valeur)*
...
**K. Back-office Admin**
- Interface admin sécurisée (accès restreint, authentification renforcée)
- Gestion utilisateurs : liste, statut, palier, actions
- Génération et gestion des codes promo (durée et niveau paramétrables)

---

**CE QUE J'ATTENDS EN RÉPONSE À CE MESSAGE**

1. **Confirmation de compréhension** du cahier des charges complet et des trois phases
...
6. **Plan d'action Phase 1** détaillé et prêt à valider avant tout code
